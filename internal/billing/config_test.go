...
func TestDecodeConfigDefaults(t *testing.T) {
	...
	if !cfg.Enabled || cfg.Debug || !cfg.CodexFastModeBilling || cfg.BillingMultiplier != 1 || cfg.MaskAPIKeyViewEmails || cfg.AllowAPIKeyQuotaReset || cfg.StateFile != DefaultStateFile {
