...
SUCCESS_EVENT_SAMPLES = [
    ...
    event_sample(0, "codex · fast-policy@example.com", "codex", "gpt-5.5", "CodexExecutor", "low", "priority", 1200, 300, 50, (1000, 400, 0, 200), (5, 0.5, 5, 30), multiplier=2.5, response_tier="default", pricing={"service_tier":"priority","tier_source":"request_policy","method":"oauth_multiplier","rule_version":"codex-oauth-family-v8"}, stream=True),
